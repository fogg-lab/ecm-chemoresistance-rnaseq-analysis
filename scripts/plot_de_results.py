...
def create_volcano_plot(
    ...
    Args:
        ...
        cohort_name (str): Name of the cohort for plot title and filename.
    ...
    output_file = os.path.join(output_dir, f"volcano_plot_{cohort_name}.html")
...
def create_mean_difference_plot(
    df: pd.DataFrame, fdr: float, output_dir: str, cohort_name: str
) -> None:
    """
    ...
    output_file = os.path.join(output_dir, f"mean_difference_{cohort_name}.html")
    fig.write_html(output_file)
    print(f"Saved mean difference plot to {output_file}")
